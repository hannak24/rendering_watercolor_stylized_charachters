...
float modelYawAngle = 0;
float modelRollAngle = 0;
...
int main()
{
    ...
    Shader lightCubeShader("vShader.glsl", "lightCubefShader.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("pointLights[0].diffuse", 1.0f, 0.0f, 1.0f);
